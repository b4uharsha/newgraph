#!/usr/bin/env bash
# scripts/push.sh - Push falkordb-wrapper to container registry
#
# Usage:
...
# For GKE deployments, this pushes to gcr.io/hsbc-graph/falkordb-wrapper.
