...
<div class="nb-header">
  ...
  <h1 class="nb-header__title">Reference Cleanup</h1>
  <p class="nb-header__subtitle">Remove stale reference instances, mappings, and personas</p>
</div>

```python
USERNAME = "_FILL_ME_IN_"  # Your email — used to derive the reference namespace
```
...
print(f"Cleaning reference namespace: {namespace}")
