...
<div class="nb-header">
  ...
  <h1 class="nb-header__title">UAT Cleanup</h1>
  <p class="nb-header__subtitle">Remove stale UAT instances, mappings, and personas</p>
</div>

```python
USERNAME = "_FILL_ME_IN_"  # Your email — used to derive the UAT namespace
```
...
print(f"Cleaning UAT namespace: {namespace}")
